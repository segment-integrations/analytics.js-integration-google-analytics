...
exports.loadEnhancedEcommerce = function(track) {
  if (!this.enhancedEcommerceLoaded) {
    window.ga(this._getTrackerName() + 'require', 'ec');
    this.enhancedEcommerceLoaded = true;
  }

  // Ensure we set currency for every hit
  window.ga(this._getTrackerName() + 'set', '&cu', track.currency());
};
...
exports.checkoutStepViewed = function(track) {
  ...
  this.addProduct(track, track.products());

  window.ga(this._getTrackerName() + 'ec:setAction', 'checkout', buildActionFieldObject(track, 'checkout'));
...
exports.checkoutStepCompleted = function(track) {
  ...
  window.ga(this._getTrackerName() + 'ec:setAction', 'checkout_option', buildActionFieldObject(track, 'checkout_option'));

  window.ga(this._getTrackerName() + 'send', 'event', 'Checkout', 'Option');
};
...
exports.orderCompleted = function(track) {
  ...
  window.ga(this._getTrackerName() + 'ec:setAction', 'purchase', buildActionFieldObject(track, 'purchase'));
...
exports.orderRefunded = function(track) {
  ...
  window.ga(this._getTrackerName() + 'ec:setAction', 'refund', buildActionFieldObject(track, 'refund'));
...
exports.productAdded = function(track) {
  ...
  this.addProduct(track);

  window.ga(this._getTrackerName() + 'ec:setAction', 'add', buildActionFieldObject(track));
...
exports.productRemoved = function(track) {
  ...
  window.ga(this._getTrackerName() + 'ec:setAction', 'remove', buildActionFieldObject(track));
...
exports.productViewed = function(track) {
  ...
  window.ga(this._getTrackerName() + 'ec:setAction', 'detail', buildActionFieldObject(track));
...
exports.productClicked = function(track) {
  ...
  window.ga(this._getTrackerName() + 'ec:setAction', 'click', buildActionFieldObject(track));
...
exports.promotionViewed = function(track) {
  ...
  window.ga(this._getTrackerName() + 'ec:addPromo', buildPromoFieldObject(track));
...
exports.promotionClicked = function(track) {
  ...
  window.ga(this._getTrackerName() + 'ec:setAction', 'promo_click', {});
...
/**
 * Invoke `ec:addProduct` for products array or individual product.
 * Can take an array of products or an individual track event with product data.
 *
 * @param {Track} track
 * @param {Array} products
 */

exports.addProduct = function(track, products) {
  if (products && Array.isArray(products)) {
    return products.forEach(function(product) {
      this.addProduct(createProductTrack(track, product));
    }.bind(this));
  }
  window.ga(this._getTrackerName() + 'ec:addProduct', buildProductFieldObject(track));
};
...
/**
 * Builds a productFieldObject from a track event or a track event and a product that has been transformed into a track event.
...
/**
 * Builds an impressionFieldObject from a track event or a track event and a product that has been transformed into a track event.
...
/**
 * Builds and actionFieldObject from a Track event.
...
/**
 * Builds a promoFieldObject from a track event.
