...
exports.initialize = function() {
  ...
  var initializeOptions = reject({
    ...
    cookieDomain: options.domain || 'auto',
    allowLinker: true
  });
  ...
  // Set global options.
  window.ga(this._getTrackerName() + 'set', globalOptions);

  // Require supported plugins.
  if (options.optimize) window.ga(this._getTrackerName() + 'require', options.optimize);

  // Display features: https://developers.google.com/analytics/devguides/collection/analyticsjs/display-features
  if (options.doubleClick) window.ga(this._getTrackerName() + 'require', 'displayfeatures');
  ...
  if (options.enhancedLinkAttribution) window.ga(this._getTrackerName() + 'require', 'linkid', 'linkid.js');
  ...
  window.ga(this._getTrackerName() + 'set', metrics(userTraits, options));
...
exports.sendEvent = function(hitType, payload, properties, options) {
  ...
  window.ga(this._getTrackerName() + 'send', hitType, payload);
};
...
exports.setContextParams = function(facade) {
  ...
  window.ga(this._getTrackerName() + 'set', trafficSources);
  ...
  window.ga(this._getTrackerName() + 'set', contentInfo);
};